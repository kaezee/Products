...
export type Theme = "paper" | "grey" | "dark" | "system";
const KEY = "k.theme";

export function getStoredTheme(): Theme {
  try { const t = localStorage.getItem(KEY) as Theme | null; return t ?? "paper"; } catch { return "paper"; }
}

function resolve(t: Theme): "paper" | "grey" | "dark" {
